/*
 Un texto está bien parentizado si por cada paréntesis abierto hay otro detrás que lo cierra. Por ejemplo, la cadena: Esto (es (un ejemplo) (de) una (cadena bien) parentizada) está bien parentizada. Pero la cadena: una )cadena (mal (parentizada) no lo está. Diseña un programa que nos diga si una cadena está bien parentizada o no.
 */
public class E14Parentesis {
